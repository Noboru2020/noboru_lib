...
data:
  ...
  bundledCode: "#line 1 \"verify-code/yosupojudge/graph/dijkstra-verify.cpp\"\n#define\
    ...
    \      }\n    }\n    return dis;\n}\n#line 3 \"verify-code/yosupojudge/graph/dijkstra-verify.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify-code/yosupojudge/graph/dijkstra-verify.cpp
layout: document
redirect_from:
- /library/verify-code/yosupojudge/graph/dijkstra-verify.cpp
- /library/verify-code/yosupojudge/graph/dijkstra-verify.cpp.html
